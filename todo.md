...
- T8 final re-grade (fresh reviewer, 10-part rubric)
- Merge portfolio-100 → main + push (USER APPROVAL REQUIRED — push deploys to kemalbarandursun.com)
- User manual steps: apply github-updates/ after review (controller can run the gh commands on approval), pin 6 repos in GitHub UI, consider custom domains for the 2 Railway app URLs (EconSight, Newspaper)
